    ...
    function displayWeather(weatherData, destination) {
      weatherCard.innerHTML = `
        ...
        <div class="weather-grid">
          <div class="weather-detail"><strong>Condition:</strong> ${weatherData.weather[0].description}</div>
          <div class="weather-detail"><strong>Temperature:</strong> ${Math.round(weatherData.main.temp)}°C</div>
          <div class="weather-detail"><strong>Humidity:</strong> ${weatherData.main.humidity}%</div>
          <div class="weather-detail"><strong>Wind Speed:</strong> ${weatherData.wind.speed} m/s</div>
        </div>
      `;
